...
public class ChatWidget extends AppWidgetProvider {
  ...
  //  public static Recipe mRecipeSelected;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, ChatWidget.class));
        ...
        if (action.equals("android.appwidget.action.APPWIDGET_UPDATE")) {
            ...
            ChatWidget.updateBakingWidgets(context, appWidgetManager, appWidgetIds);
